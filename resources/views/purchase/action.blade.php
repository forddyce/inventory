<div class="btn-group">
  <a href="{{ route('purchase.invoice.print', ['id' => $model->id]) }}" class="btn btn-info" target="_blank">
  ...
  <button class="btn btn-danger btn-delete" data-url="{{ route('purchase.delete', ['id' => $model->id]) }}">
