...
@section('title')
Laporan Pembelian Per Supplier - {{ config('app.name') }}
@stop
...
@section('content')
  <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-narrow">
    ...
    <main id="main-container">
      <div class="content">
        <h2 class="content-heading">Laporan Pembelian Per Supplier</h2>
        <div class="row">
          <div class="col-md-8">
            <div class="block">
              ...
              <div class="block-content block-content-full">
                <form target="_blank" action="{{ route('purchase.report.result') }}">
