...
@section('title')
Semua Pembelian - {{ config('app.name') }}
@stop
            ...
            <div class="block">
              <div class="block-header block-header-default">
                ...
                <div class="block-options">
                  <a href="{{ route('purchase.new') }}" title="Tambah Pembelian" class="btn-block-option">
              ...
              <div class="block-content block-content-full">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped table-vcenter js-dataTable-full table-grid" data-url="{{ route('purchase.list') }}">
                    <thead>
                      <tr>
                        <th data-id="created_at">Tanggal Dibuat</th>
                        <th data-id="created_by">Dibuat Oleh</th>
                        <th data-id="total_final">Total</th>
                        <th data-id="is_complete">Status</th>
                        <th data-id="supplier" data-sortable="false" data-searchable="false">Supplier</th>
