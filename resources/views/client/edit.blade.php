...
@section('title')
Edit Klien #{{ $model->id }} - {{ config('app.name') }}
@stop
...
@section('content')
  <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-narrow">
    ...
    <main id="main-container">
      <div class="content">
        <h2 class="content-heading">Edit Klien #{{ $model->id }}</h2>
        <div class="row">
          <div class="col-md-6">
            <div class="block">
              ...
              <div class="block-content">
                <form class="action-form" data-url="{{ route('client.update', ['id' => $model->id]) }}" http-type="patch">
                  <div class="form-group row">
                    <div class="col-md-9">
                      <div class="form-material floating">
                        <input type="text" class="form-control" id="inputName" name="client_name" required="" value="{{ $model->client_name }}">
                  ...
                  <div class="form-group row">
                    <div class="col-md-9">
                      <div class="form-material floating">
                        <select class="form-control" name="region_id" id="inputRegion">
                              ...
                              <optgroup label="{{ $region->region_name }}">
                                ...
                                @if (count($childrenRegion) > 0)
                                  @foreach ($childrenRegion as $child)
                                    <option @if ($model->region_id == $child->id) selected="" @endif value="{{ $child->id }}">{{ $child->region_name }}</option>
                                  @endforeach
                                @else
                  ...
                  <div class="form-group row">
                    <div class="col-md-9">
                      <div class="form-material floating">
                        <input type="text" class="form-control" id="inputPhone" name="client_phone" value="{{ $model->client_phone }}">
                  ...
                  <div class="form-group row">
                    <div class="col-md-9">
                      <div class="form-material floating">
                        <textarea class="form-control" id="inputAddress" name="client_address" maxlength="2500">{{ $model->client_address }}</textarea>
                  ...
                  <div class="form-group row">
                    <div class="col-md-9">
                      <div class="form-material floating">
                        <textarea class="form-control" id="inputNotes" name="client_notes" maxlength="2500">{{ $model->client_notes }}</textarea>
