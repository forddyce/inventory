          ...
          <div class="block">
            <div class="block-header block-header-default">
              ...
              <div class="block-options">
                <a href="{{ route('supplier.all') }}" title="Semua Supplier" class="btn-block-option">
            ...
            <div class="block-content">
              <form class="action-form" data-url="{{ route('supplier.add') }}" http-type="put">
                <div class="form-group row">
                  <div class="col-md-9">
                    <div class="form-material floating">
                      <input type="text" class="form-control" id="inputName" name="supplier_name" required="">
                ...
                <div class="form-group row">
                  <div class="col-md-9">
                    <div class="form-material floating">
                      <textarea class="form-control" name="supplier_address" id="inputAddress"></textarea>
                ...
                <div class="form-group row">
                  <div class="col-md-9">
                    <div class="form-material floating">
                      <textarea class="form-control" name="supplier_notes" id="inputNotes"></textarea>
