...
<div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-narrow">
  ...
  <main id="main-container">
    <div class="content">
      <h2 class="content-heading">Semua Item</h2>
      <div class="row">
        <div class="col-md-12">
          <div class="block">
            <div class="block-header block-header-default">
              ...
              <div class="block-options">
                <a href="{{ route('item.new') }}" title="Tambah Item" class="btn-block-option">
            ...
            <div class="block-content block-content-full">
              <table class="table table-bordered table-striped table-vcenter js-dataTable-full table-grid" data-url="{{ route('item.list') }}">
                <thead>
                  <tr>
                    <th data-id="created_at">Tanggal Dibuat</th>
                    <th data-id="created_by">Dibuat Oleh</th>
                    <th data-id="item_name">Nama</th>
                    <th data-id="item_code">Kode Unik</th>
                    <th data-id="stock">Stok</th>
