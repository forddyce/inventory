...
@section('title')
Semua Pelunasan Piutang - {{ config('app.name') }}
@stop
...
<div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-narrow">
  ...
  <main id="main-container">
    <div class="content">
      <h2 class="content-heading">Semua Pelunasan Piutang</h2>
      <div class="row">
        <div class="col-md-12">
          <div class="block">
            <div class="block-header block-header-default">
              ...
              <div class="block-options">
                <a href="{{ route('receivable.add') }}" title="Tambah Pelunasan Piutang" class="btn-block-option">
            ...
            <div class="block-content block-content-full">
              <table class="table table-bordered table-striped table-vcenter js-dataTable-full table-grid" data-url="{{ route('receivable.invoice.list') }}">
                <thead>
                  <tr>
