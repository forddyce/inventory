...
@section('title')
Semua Pelunasan Hutang - {{ config('app.name') }}
@stop
...
<div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-narrow">
  ...
  <main id="main-container">
    <div class="content">
      <h2 class="content-heading">Semua Pelunasan Hutang</h2>
      <div class="row">
        <div class="col-md-12">
          <div class="block">
            <div class="block-header block-header-default">
              ...
              <div class="block-options">
                <a href="{{ route('debt.add') }}" title="Tambah Pelunasan Hutang" class="btn-block-option">
                  <i class="si si-plus"></i> Pelunasan
                </a>
              </div>
            </div>

            <div class="block-content block-content-full">
              <table class="table table-bordered table-striped table-vcenter js-dataTable-full table-grid" data-url="{{ route('debt.invoice.list') }}">
                <thead>
                  <tr>
                    <th data-id="created_at">Tanggal Dibuat</th>
                    <th data-id="created_by">Dibuat Oleh</th>
                    <th data-id="amount">Jumlah</th>
                    <th data-id="amount_left">Kelebihan</th>
                    <th data-id="supplier_name" data-sortable="false" data-searchable="false">Supplier</th>
